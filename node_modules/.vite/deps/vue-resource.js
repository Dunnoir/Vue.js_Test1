...
// browser-external:got
var require_got = __commonJS({
  "browser-external:got"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "got" has been externalized for browser compatibility. Cannot access "got.${key}" in client code.`);
        }
      }
    }));
  }
...
function Util(_ref2) {
  var config = _ref2.config, nextTick2 = _ref2.nextTick;
  ntick = nextTick2;
...
function query(options$$1, next) {
  var urlParams = Object.keys(Url.options.params), query2 = {}, url = next(options$$1);
...
function json(request) {
  ...
  return function(response) {
    return response.bodyText ? when(response.text(), function(text) {
      ...
      if (type2.indexOf("application/json") === 0 || isJson(text)) {
        try {
...
var Headers = function() {
  ...
  _proto.set = function set2(name, value) {
...
var vue_resource_esm_default = plugin;
export {
  Http,
  Resource,
  Url,
  vue_resource_esm_default as default
};
/*!
 * vue-resource v1.5.3
